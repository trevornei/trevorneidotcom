...
export default function Hero() {
  ...
  return (
    <>
      <div className="absolute slide opacity-0 z-30 mb-20 hidden -rotate-[10deg] overflow-hidden bg-tp sm:left-[215px] sm:top-[497px] sm:block md:left-[200px] md:top-[500px] md:mb-32 md:block lg:left-[450px] lg:top-[680px] lg:block lg:-rotate-[15deg] xl:block 2xl:block">
        <h1
      ...
      <div className="b-36 opacity-0 slide relative mb-36 mt-16 flex h-1/2 w-10/12 flex-col items-center justify-end overflow-hidden rounded-3xl border-[1px] border-white sm:h-[300px] sm:w-10/12 sm:flex-row md:h-auto md:w-10/12 md:flex-row lg:h-[500px] lg:w-10/12 xl:h-[500px] xl:w-10/12 xl:flex-row 2xl:w-10/12">
