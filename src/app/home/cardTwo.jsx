      ...
      <div className="lg:px-10/12 relative flex w-screen flex-row flex-wrap overflow-hidden border-[1px] border-white sm:flex-row md:flex-row lg:flex-row xl:my-72 xl:rounded-none xl:backdrop-blur-3xl">
        <div className="relative z-10 flex h-full w-full items-center justify-center">
          <Image
            ...
            className="absolute right-0 top-0 h-auto w-[150px] object-cover sm:right-0 sm:top-0 sm:h-auto sm:w-[280px] md:right-0 md:top-0 md:h-auto md:w-[390px] lg:right-0 lg:top-0 lg:h-auto lg:w-[500px] xl:-right-20 xl:top-0 xl:h-auto xl:w-[500px] 2xl:right-0 2xl:top-0"
            width={800}
            height={800}
          />
        </div>
