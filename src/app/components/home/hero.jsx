...
export default function Hero() {
  return (
    <>
      ...
      <div className="b-36 relative mb-36 mt-28 flex h-1/2 w-10/12 flex-col items-center justify-end overflow-hidden rounded-3xl border-2 border-tpink/20 shadow-lg shadow-tp/30 sm:h-[300px] sm:w-10/12 sm:flex-row md:h-auto md:w-10/12 md:flex-row lg:h-[500px] lg:w-10/12 xl:h-[500px] xl:w-10/12 xl:flex-row 2xl:w-10/12">
