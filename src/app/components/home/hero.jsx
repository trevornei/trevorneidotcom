...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="b-36 moveHero relative mb-36 mt-28 flex h-1/2 w-10/12 flex-col items-center justify-end overflow-hidden rounded-3xl border-2 border-tpink/20 shadow-lg shadow-tp/30 sm:h-[300px] sm:w-10/12 sm:flex-row md:h-auto md:w-10/12 md:flex-row lg:h-[500px] lg:w-10/12 xl:h-[500px] xl:w-10/12 xl:flex-row 2xl:w-10/12">
        ...
        <div className="relative z-10 my-0 flex h-full w-full flex-col items-center justify-end overflow-hidden rounded-t-none bg-black/50 sm:h-[300px] sm:w-full md:w-1/2 md:items-end md:rounded-3xl md:rounded-l-none lg:h-full lg:w-96 lg:items-center lg:justify-center lg:rounded-l-none xl:w-1/2 xl:items-end xl:justify-center xl:rounded-l-none 2xl:w-1/2 2xl:rounded-l-none">
          <div className="m-0 my-0 flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-3xl bg-black/50 p-10 shadow-lg backdrop-blur-md sm:m-0 sm:my-0 sm:h-full sm:items-center sm:rounded-none sm:py-10 md:w-full md:rounded-l-none md:py-10 lg:m-0 lg:h-full lg:w-full lg:items-center lg:justify-center lg:rounded-l-none lg:px-8 lg:py-10 xl:h-full xl:w-full xl:items-center xl:justify-center xl:rounded-l-none xl:py-16 2xl:rounded-l-none">
            ...
            <div className="flex flex-row items-start justify-start gap-x-2 sm:flex-col">
              <h1 className="mx-none software text-2xl font-extrabold text-white md:text-5xl lg:text-6xl xl:mx-8 xl:pb-5 xl:text-6xl">
                SOFTWARE
              </h1>
              <h1 className="engineer text-2xl font-extrabold text-tp md:text-5xl lg:text-6xl xl:mx-8 xl:text-6xl">
                ENGINEER
              </h1>
            </div>
