...
export default function CardThree() {
  return (
    <>
      <div className="relative mt-36 grid grid-cols-4 grid-rows-5 gap-16 xl:mb-20 xl:w-10/12">
        <Image
          src="/assets/images/ma_cherry/el 10.png"
          className="absolute inset-0 -translate-x-32 rotate-35 blur-[300px]"
          alt="Another logo"
          width={800}
          height={800}
        />
        <Image
          src="/assets/images/ma_cherry/el 10.png"
          className="absolute bottom-0 right-0 translate-x-72 translate-y-56 rotate-180 blur-[600px]"
          alt="Another logo"
          width={800}
          height={800}
        />
        ...
        <div className="glassy flex flex-row xl:col-span-3 xl:col-start-2 xl:row-start-2 xl:justify-items-start">
          <Image
        ...
        <div className="glassy flex flex-row xl:col-span-3 xl:col-start-2 xl:row-start-3 xl:justify-items-end">
          <Image
        ...
        {/*Card Three */}
        <div className="glassy flex flex-row justify-items-start xl:col-span-3 xl:col-start-2 xl:row-start-5">
          <Image
